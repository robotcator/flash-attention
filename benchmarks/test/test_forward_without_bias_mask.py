...
output_ref, softmax_output_ref = _attention(normal_attn_v1, normal_attn_v1, normal_attn_v1, mask=None, upcast=True)
# be careful here
...
output_pt, softmax_output_pt = _attention(normal_attn_v2, normal_attn_v2, normal_attn_v2, mask=None)
# be careful here
...
output3 = _flash_attn(normal_attn_flash, normal_attn_flash, normal_attn_flash, attn_mask=None)
# import pdb; pdb.set_trace()
