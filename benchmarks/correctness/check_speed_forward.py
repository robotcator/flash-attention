...
def fun(seqlen=128, verbose=False, has_bias=True, has_mask=True):
    ...
    try:
        t1, m1 = benchmark_forward(_attention, inputs, mask=mask, bias=bias, repeats=100, desc='Normal Attention forward')
        # print (m1)
    ...
    try:
        t2, m2 = benchmark_forward(_flash_attn, inputs, mask=mask, bias=bias, repeats=100, desc='Flash Attention forward')
        # print (m2)
