...
def _flash_attn(q, k, v, mask=None, bias=None):
    ...
    if mask is not None:
        ...
        # if src_len % 2 != 0:
        #     mask_pad = F.pad(mask, (0, 1), "constant", 0)
        #     # mask_pad = F.pad(mask, (0, 1), "constant", 0).contiguous()
    ...
    if bias is not None:
        ...
        # if src_len % 2 != 0:
        #     # why will cause unsynchornize problem
        #     bias_pad = F.pad(bias, (0, 1), "constant", 0).contiguous()
